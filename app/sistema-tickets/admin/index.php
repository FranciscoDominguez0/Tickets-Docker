...
/**
 * ADMIN/AGENTE
 * Panel admin - solo muestra panel si está logueado
 */
...
// Redirigir al nuevo panel en upload/scp/
    ...
    <body>
        ...
        <nav class="navbar navbar-dark">
            <div class="container-fluid">
                <span class="navbar-brand"><?php echo APP_NAME; ?> - Admin</span>
            ...
            <div class="action-cards">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="tickets.php" class="btn-action">Ver Tickets</a>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="all-tickets.php" class="btn-action">Ver Todos</a>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="profile.php" class="btn-action">Editar Perfil</a>
                    </div>
                </div>
            </div>
        </div>
